...
import { saveToken } from "../../Admin/Notiifcations/api";   // same api file jahan aapka saveToken() hai
...
const EmployeeDashboard = () => {
  ...
  const setupFCM = async () => {
    try {
      ...
      // Token nikalna
      const VAPID_KEY = "BBrmFxSoxxTJSvX7C4cMqpeNg437_GvbxC9pPQ6rjbtii8lR8iqHy8CfWo-BLVIu7TN53LobGEi6clH6rXSG-nw";
      ...
      if (token) {
        ...
        // Optional: SW ko bhi inform karna
      ...
      onForegroundMessage((payload) => {
        console.log("Dashboard Foreground Msg:", payload);
      ...
      console.error("Error setting up FCM in dashboard:", error);
    }
  };
