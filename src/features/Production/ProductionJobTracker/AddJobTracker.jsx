...
function AddJobTracker() {
  ...
  // Fixed: Get project name and number directly from the project data
  const selectedProject = project?.data?.find(p => p._id === formData.projectsId);
  const selectedProjectName = selectedProject?.projectName || "";
  const selectedProjectNumber = selectedProject?.projectNo || "";
        ...
        <div className="card shadow-sm">
          <div className="card-body">
            ...
            <form className="row g-3" onSubmit={handleSubmit}>
              ...
              {/* Project Number - Fixed to use actual projectNo from API */}
              <div className="col-md-6">
                <label className="form-label">Project Number</label>
                <input
                  type="text"
