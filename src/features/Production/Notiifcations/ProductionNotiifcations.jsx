...
import { API_BASE, saveToken , sendTestNotification } from "../../Admin/Notiifcations/api";
...
function Notiifcations() {
  ...
  try {
    const response = await axios.delete(`${apiUrl}/notifiction/deleteNotification/${id}`);
            ...
            return (
              <div key={category} className="mb-4">
                ...
                {categoryNotifications.map((notification) => (
                  ...
                  <button className="btn btn-sm btn-danger position-absolute top-0 end-0 m-2" onClick={() => removeNotification(notification.id)}>
                    Delete
                  </button>
                    </div>
                  </div>
