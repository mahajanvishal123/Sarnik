            ...
            <div className="row mb-3">
              <div className="col-md-4 mb-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <Link to={"/production/AddClientManagement"}><button class="btn btn-sm btn-outline-primary rounded-pill px-3 py-1">
                    + Create
                  </button></Link>
                </div>
                <select
              ...
              <div className="col-md-4 mb-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <Link to={"/production/AddProjectList"}><button class="btn btn-sm btn-outline-primary rounded-pill px-3 py-1">
                    + Projects
                  </button></Link>
                </div>
                <select
